    ...
    <div class="am-tabs am-margin" data-am-tabs>
      ...
      <div class="am-tabs-bd">
        ...
        <div class="am-tab-panel am-fade am-in am-active" id="tab1">
          <form class="am-form" method="post" action="room_update.action">
        	 <div class="am-g am-margin-top">
              <div class="am-u-sm-4 am-u-md-2 am-text-right">
                	宿舍号
              </div>
              <div class="am-u-sm-8 am-u-md-4">
                <input type="text" name="room.roomid" class="am-input-sm" value="<%=request.getParameter("room.roomid") %>" readonly>
              </div>
           ...
           <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                <input type="text" name="room.chargeid" class="am-input-sm">
              </div>
            </div>
          ...
          <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                <input type="text" name="room.score" class="am-input-sm">
              </div>
            </div>
           ...
           <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                <input type="text" name="room.status" class="am-input-sm">
              </div>
            </div>
